...
function auto() {
    // const email = "vip.matvey.ovchinnikov.2015@mail.ru"
    $("#form-name").val("Матвей")
    phoneMask.value = "+79194741520"
    $("#form-email").val("matvey.ovchinnikov.2014@mail.ru")
    $("#form-policy").attr("checked", true)
}
